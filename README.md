...
- Area of Expertise: Native Windows applications using Win32 and C/C++/Rust/Go, Web applications, Cloud services (Google Cloud, AWS, Azure), Docker, Java, TypeScript, RDB, NoSQL, etc.

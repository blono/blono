...
- Area of Expertise: Native Windows applications using Win32, web applications, cloud services (AWS, Google Cloud, Azure), Docker, etc.
- Editor: xyzzy/Visual Studio Code/Visual Studio/Sublime Text/CotEditor
